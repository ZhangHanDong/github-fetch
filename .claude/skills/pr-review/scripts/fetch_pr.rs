//! Script to fetch PR information including reviews, comments, and diffs
//!
//! Usage: cargo run --example fetch_pr -- <owner> <repo> <pr_number>
//!
//! Example: cargo run --example fetch_pr -- tokio-rs axum 2865
